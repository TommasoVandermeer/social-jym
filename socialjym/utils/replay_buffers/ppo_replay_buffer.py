...
class PPOBuffer(BaseVNetReplayBuffer):
    def __init__(
        self,
        buffer_size: int,
        batch_size: int,
    ...
    def add(
        ...
        buffer_state["old_values"] = buffer_state["old_values"].at[filling_idx].set(old_value)
        buffer_state["old_neglogpdfs"] = buffer_state["old_neglogpdfs"].at[filling_idx].set(old_neglogpdf)
    ...
    def batch_add(
        ...
        buffer_state["old_values"] = buffer_state["old_values"].at[filling_idxs].set(old_values)
        buffer_state["old_neglogpdfs"] = buffer_state["old_neglogpdfs"].at[filling_idxs].set(old_neglogpdfs)
    ...
    def empty(
        ...
        buffer_state["old_values"] = buffer_state["old_values"].at[:].set(0)
