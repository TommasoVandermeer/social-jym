...
class RewardAblation(BaseReward):
    def __init__(
        self, 
        ...
        pass_right_penalty_reward: bool=True,
        time_limit: float=50.,
        goal_reward: float=1., 
        ...
        assert kinematics in ROBOT_KINEMATICS, "kinematics must be one of the following: {ROBOT_KINEMATICS}"
        # Define reward type
        ...
        self.pass_right_penalty_reward = pass_right_penalty_reward
        binary_reward = jnp.array([
            pass_right_penalty_reward,
        ...
        decimal_reward = binary_to_decimal(binary_reward)
        self.type = f"socialnav_reward_ablation_{decimal_reward}"
