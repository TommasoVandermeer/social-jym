...
#             human_goal = jnp.clip(human_pos + jnp.array([distance * jnp.cos(angle), distance * jnp.sin(angle)]), jnp.array([-15, -10]), jnp.array([15, 10]))
...
# with open(os.path.join(os.path.dirname(__file__), 'custom_episodes.pkl'), 'wb') as f:
#     pickle.dump(custom_episodes, f)
# Load custom episodes
with open(os.path.join(os.path.dirname(__file__), 'custom_episodes.pkl'), 'rb') as f:
...
#     )
#     for o in obstacles: ax.plot(o[0,:,0],o[0,:,1], color='black', linewidth=2, zorder=3)
#     ax.scatter(custom_episodes['humans_goal'][trial, :, 0], custom_episodes['humans_goal'][trial, :, 1], marker="*", color=colors, zorder=2)
#     ax.set_aspect('equal')
#     plt.show()
...
### Save results
with open(os.path.join(os.path.dirname(__file__),"dir_safe_tests_long_nav.pkl"), 'wb') as f:
    pickle.dump(all_metrics, f)
# with open(os.path.join(os.path.dirname(__file__),"dwa_tests_long_nav.pkl"), 'wb') as f:
#     pickle.dump(all_metrics_dwa, f)

### Load results
with open(os.path.join(os.path.dirname(__file__),"dir_safe_tests_long_nav.pkl"), 'rb') as f:
    all_metrics = pickle.load(f)
# with open(os.path.join(os.path.dirname(__file__),"dwa_tests_long_nav.pkl"), 'rb') as f:
