...
policies = {
    ...
    "jessi_legit": {"label": "JESSI-MULTITASK-LEGIT", "short": "JESSI-L", "only_ccso": False, "color": "tab:orange"}
}
...
if not os.path.exists(os.path.join(os.path.dirname(__file__),"jessi_legit_tests.pkl")):

    ### JESSI-MULTITASK FULL ###
    if not os.path.exists(os.path.join(os.path.dirname(__file__),"jessi_multitask_full_tests.pkl")):
        ...
        with open(os.path.join(os.path.dirname(__file__),"jessi_multitask_full_tests.pkl"), 'wb') as f:
            pickle.dump(all_metrics, f)

    ### JESSI-MULTITASK LEGIT ###
    if not os.path.exists(os.path.join(os.path.dirname(__file__),f"jessi_multitask_legit_tests.pkl")):
        # Load JESSI-MULTITASK policy parameters
        with open(os.path.join(os.path.dirname(__file__), f"jessi_multitask_rl_out_legit.pkl"), 'rb') as f:
            _, jessi_params, _ = pickle.load(f)
        # Execute tests
        policy = JESSI(
            lidar_num_rays=100,
        ...
        all_metrics = jessi_tests(policy, jessi_params)
        with open(os.path.join(os.path.dirname(__file__),f"jessi_multitask_legit_tests.pkl"), 'wb') as f:
            pickle.dump(all_metrics, f)
    ...
    with open(os.path.join(os.path.dirname(__file__),f"jessi_multitask_legit_tests.pkl"), 'rb') as f:
        all_results[f"jessi_legit"] = pickle.load(f)
    with open(os.path.join(os.path.dirname(__file__),"jessi_legit_tests.pkl"), 'wb') as f:
        pickle.dump(all_results, f)
else:
    with open(os.path.join(os.path.dirname(__file__),"jessi_legit_tests.pkl"), 'rb') as f:
