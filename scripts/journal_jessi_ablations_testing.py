...
if not os.path.exists(os.path.join(os.path.dirname(__file__),"jessi_ablation_tests.pkl")):
    ...
    for a, ablation_mode in enumerate(ABLATIONS):
        if not os.path.exists(os.path.join(os.path.dirname(__file__),f"jessi_multitask_ablation_{ablation_mode}_tests.pkl")):
            ...
            all_metrics = jessi_tests(policy, jessi_params)
            with open(os.path.join(os.path.dirname(__file__),f"jessi_multitask_ablation_{ablation_mode}_tests.pkl"), 'wb') as f:
                pickle.dump(all_metrics, f)
    ...
    with open(os.path.join(os.path.dirname(__file__),"jessi_ablation_tests.pkl"), 'rb') as f:
