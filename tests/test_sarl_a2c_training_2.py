...
replay_buffer = BaseA2CBuffer(training_hyperparams['il_buffer_size'], training_hyperparams['il_batch_size'])
...
replay_buffer = BaseA2CBuffer(training_hyperparams['rl_batch_size'], training_hyperparams['rl_batch_size'])
